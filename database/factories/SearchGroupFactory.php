...
class SearchGroupFactory extends Factory
{
    ...
    {
        $max = $this->faker->numberBetween(2, 20);
        ...
        return [
            ...
            'start_time' => $this->faker->dateTimeBetween('-2 days', '+1 day'),
            ...
            'allocated_lat' => $this->faker->latitude(),
            'allocated_lng' => $this->faker->longitude(),
            'radius' => $this->faker->numberBetween(50, 5000),
        ];
    }
}
